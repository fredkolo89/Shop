...
namespace _45.Db
{
    public class Initializer : DropCreateDatabaseAlways<DataBase>
    {
        ...
        public void SeedData(DataBase context)
        {
            ...
            {
                new Data2() { studia = "1 stopień",doswiadczenie = "brak doswiadczenia" ,znajomoscAngielskiego = "nie",plec="mezczyzna",rezultat = false},
                new Data2() { studia = "1 stopień",doswiadczenie = "wysokie doswiadczenie" ,znajomoscAngielskiego = "tak",plec="kobieta",rezultat = true},
                new Data2() { studia = "2 stopień",doswiadczenie = "brak doswiadczenia",znajomoscAngielskiego = "tak",plec="mezczyzna", rezultat = true},
                new Data2() { studia = "1 stopień",doswiadczenie = "wysokie doswiadczenie",znajomoscAngielskiego = "nie",plec="mezczyzna", rezultat = true},
                new Data2() { studia = "brak",doswiadczenie = "srednie doswiadczenie",znajomoscAngielskiego = "tak",plec="kobieta", rezultat = true},
                new Data2() { studia = "brak",doswiadczenie = "brak doswiadczenia",znajomoscAngielskiego = "tak", plec="mezczyzna",rezultat = false},
                new Data2() { studia = "2 stopień",doswiadczenie = "srednie doswiadczenie",znajomoscAngielskiego = "tak", plec="kobieta",rezultat = true},
                new Data2() { studia = "1 stopień",doswiadczenie = "brak doswiadczenia",znajomoscAngielskiego = "tak",plec="kobieta", rezultat = false},
                new Data2() { studia = "1 stopień",doswiadczenie = "brak doswiadczenia",znajomoscAngielskiego = "nie", plec="kobieta",rezultat = true},
                new Data2() { studia = "1 stopień",doswiadczenie = "srednie doswiadczenie",znajomoscAngielskiego = "nie", plec="kobieta",rezultat = true},
                new Data2() { studia = "1 stopień",doswiadczenie = "wysokie doswiadczenie",znajomoscAngielskiego = "nie", plec="kobieta",rezultat = true},
                new Data2() { studia = "2 stopień",doswiadczenie = "srednie doswiadczenie",znajomoscAngielskiego = "nie", plec="mezczyzna",rezultat = true},
                new Data2() { studia = "2 stopień",doswiadczenie = "brak doswiadczenia",znajomoscAngielskiego = "nie", plec="mezczyzna",rezultat = true},
                new Data2() { studia = "1 stopień",doswiadczenie = "wysokie doswiadczenie",znajomoscAngielskiego = "nie", plec="mezczyzna",rezultat = false},
            ...
            {
                new Data3() { bezrobocie = "male",wielkosc_rodziny = "mala",wielkosc_ubostwa = "duze",stan_zdrowotny = "zly",rezultat = false},
                new Data3() { bezrobocie = "male",wielkosc_rodziny = "duza",wielkosc_ubostwa = "male",stan_zdrowotny = "dobry",rezultat = false},
                new Data3() { bezrobocie = "duze",wielkosc_rodziny = "mala",wielkosc_ubostwa = "duze",stan_zdrowotny = "dobry",rezultat = true},
                ...
                new Data3() { bezrobocie = "srednie",wielkosc_rodziny = "mala",wielkosc_ubostwa = "srednie",stan_zdrowotny = "dobry",rezultat = true},
                new Data3() { bezrobocie = "male",wielkosc_rodziny = "srednia",wielkosc_ubostwa = "duze",stan_zdrowotny = "dobry",rezultat = false},
            ...
            new Data4() { stan_ogolny = "zly", choroba_na_oddziale = "rozyczka", samopoczucie = "dobre", goraczka = "nie", rezultat = false },
                ...
                new Data4() { stan_ogolny = "dobry", choroba_na_oddziale = "rozyczka", samopoczucie = "dobre", goraczka = "tak", rezultat = true },
                ...
                new Data4() { stan_ogolny = "zly", choroba_na_oddziale = "rozyczka", samopoczucie = "srednie", goraczka = "tak", rezultat = true },
                new Data4() { stan_ogolny = "zly", choroba_na_oddziale = "swinka", samopoczucie = "srednie", goraczka = "nie", rezultat = true },
                new Data4() { stan_ogolny = "zly", choroba_na_oddziale = "swinka", samopoczucie = "srednie", goraczka = "nie", rezultat = true },
